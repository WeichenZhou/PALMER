...
//parameters_start
    ...
    string T, WD, inputF, output, SP, ref;
    int NUM_threads=30;
    ifstream file1;
    //ofstream file2;
    int flag_wd=0;
    ...
    for(int i=1;i!=argc;i++){
        ...
        //    T=argv[i+1];
        //    cout <<"ONLY SUPPORT TO DETECT LINE INSERTION. :)"<< endl;
        //}
    ...
    if(ref_n==0){
        cout<<"PLEASE ASSIGN A CORRECT REFERENCE!"<<endl;
        exit(1);
    }
...
//Buildup & index or HG version chose
    ...
    if(ref_n==37){
      //  file11<<LINEs_regions_GRCh37;
    }
    else if(ref_n==38){
        file11<<LINEs_regions_GRCh38;
    }
